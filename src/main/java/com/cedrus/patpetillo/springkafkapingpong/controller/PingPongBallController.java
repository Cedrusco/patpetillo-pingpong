...
public class PingPongBallController {
  ...
  private ResponseEntity<ServeBallResponse> createBall(ServeBallRequest serveBallRequest) {
    ...
    try {
      ...
      try {
        final PingPongBall pingPongBall = new PingPongBall(id, currentTeam, receivingTeam, server,
            color);
        ...
        ServeBallResponse serveBallResponse = new ServeBallResponse(false, e.getMessage(),
      ...
      ServeBallResponse serveBallResponse = new ServeBallResponse(false,
